...
const URL_LOGO = 'https://tisolercdn.nyc3.cdn.digitaloceanspaces.com/agrofierros/genericas/logo-rojo-palido.svg';

const PlacaVenta = () => {
  return (
    <div
      className="
        relative flex bg-[#1E293B] w-[88%] lg:w-[75%] xl:w-[70%] 2xl:w-[50%] h-auto md:h-[408px] rounded-lg mx-auto 
    ...
    >
      <div className="flex flex-col max-w-[100%] md:max-w-[65%] gap-3 justify-between pt-[270px] pb-6 md:py-6 pl-2 md:pl-3">
        ...
        <p className="flex gap-2 items-center pr-2">
          <Image src={URL_LOGO} alt="Logo AgroFierros" width={15} height={15} className="ml-1" loading="lazy" />
      ...
      <div className="absolute !right-[-10px] md:!right-[-55px] !top-[40px] md:!top-[70px]">
        <div className="relative h-[220px] md:h-[230px] w-[320px] md:w-[350px]">
          <Image
            loader={cdnLoader}
            loading="lazy"
            src='https://tisolercdn.nyc3.cdn.digitaloceanspaces.com/agrofierros/genericas/bloque-venta.webp'
      ...
      <div className="absolute z-40 flex justify-end items-end pb-1 pr-2 pl-10 md:pl-20 pt-3 md:pt-5 top-[12px] md:top-6 right-[-10px] md:right-[-50px] bg-[#e93d44] text-2xl md:text-3xl text-[#1E293B] uppercase">
        compromiso
      </div>
    </div>
  );
